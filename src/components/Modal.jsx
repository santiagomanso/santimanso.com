          ...
          <div className='flex flex-col justify-between items-start px-5 pt-2 lg:pt-16 pb-6 w-full lg:w-1/2 h-full bg-variant1'>
            ...
            <div className='flex justify-evenly w-full  select-none text-white'>
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='flex items-center gap-1 text-lg lg:text-2xl px-7 lg:px-12 py-2 border-2 border-white border-solid rounded-md bg-variant2 cta group'
              >
                <svg
                  aria-hidden='true'
                  focusable='false'
                  ...
                  viewBox='0 0 576 512'
                  className='svg-inline--fa fa-eye fa-w-18 text-white group-hover:text-variant1 w-5 lg:w-8'
                >
                  <path
                    fill='currentColor'
              ...
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='flex gap-1 items-center text-lg lg:text-2xl px-7 lg:px-12 py-2 border-2 border-white border-solid rounded-md bg-secondary cta2 group'
              >
                <svg
                  aria-hidden='true'
                  focusable='false'
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 640 512'
                  className='svg-inline--fa fa-code fa-w-20 text-variant1 group-hover:text-white w-5 lg:w-8'
                >
                  <path
                    fill='currentColor'
                ...
                <p className='text-variant1 group-hover:text-white'>code</p>
              </a>
            </div>
          </div>
        </div>
