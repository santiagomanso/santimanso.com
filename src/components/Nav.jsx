        ...
        <nav className={`  text-secondary text-3xl`}>
          ...
          <ul className=' flex flex-col gap-5 pt-20'>
            <li className='px-5 flex justify-between items-center group'>
              <i className='opacity-30 group-hover:opacity-100  text-3xl fa-solid fa-house'></i>
            ...
            <li className='px-5 flex justify-between items-center group'>
              <i className='opacity-30 group-hover:opacity-100  text-3xl fa-solid fa-briefcase'></i>
              <p className='opacity-30 group-hover:opacity-100  text-2xl'>
                portfolio
              </p>
              <i className='opacity-30 group-hover:opacity-100  fa-solid fa-chevron-right text-2xl'></i>
            ...
            <li className='px-5 flex justify-between items-center group'>
              <i className='opacity-30 group-hover:opacity-100  text-3xl fa-solid fa-file-lines'></i>
              <p className='opacity-30 group-hover:opacity-100  text-2xl'>
                curriculum
              </p>
              <i className='opacity-30 group-hover:opacity-100  fa-solid fa-chevron-right text-2xl'></i>
            ...
            <li className='px-5 flex justify-between items-center group'>
              <i className='opacity-30 group-hover:opacity-100  text-3xl fa-brands fa-github'></i>
              <p className='opacity-30 group-hover:opacity-100  text-2xl'>
                github
              </p>
              <i className='opacity-30 group-hover:opacity-100  fa-solid fa-chevron-right text-2xl'></i>
            ...
            <li className='px-5 flex justify-between items-center group'>
              <i className='opacity-30 group-hover:opacity-100  text-3xl fa-brands fa-linkedin-in'></i>
              <p className='opacity-30 group-hover:opacity-100  text-2xl'>
                LinkedIn
              </p>
              <i className='opacity-30 group-hover:opacity-100  fa-solid fa-chevron-right text-2xl'></i>
