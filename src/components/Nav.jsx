...
const Nav = () => {
  ...
  return (
    <>
      <nav className='hidden lg:inline text-white  tracking-widest select-none'>
        <ul className='flex justify-between'>
          <li className='opacity-40 cursor-pointer hover:opacity-100 hover:text-white flex items-baseline gap-1 translate-y-0 hover:translate-y-1 hover:scale-105 transition-all ease-out duration-300'>
            <i className='fa-solid text-xl fa-home'></i>
            <a>
          ...
          <div className=' flex gap-20'>
            <li className='opacity-40 cursor-pointer hover:opacity-100 hover:text-white flex items-baseline gap-1 translate-y-0 hover:translate-y-1 hover:scale-105 transition-all ease-out duration-300'>
              <i className='fa-solid text-xl fa-briefcase'></i>
              <a>
            ...
            <li className='opacity-40 cursor-pointer hover:opacity-100 hover:text-white flex items-baseline gap-1 translate-y-0 hover:translate-y-1 hover:scale-105 transition-all ease-out duration-300'>
              ...
              <a>
                <p className='text-lg'>curriculum</p>
              </a>
            </li>
            <li className='opacity-40 cursor-pointer hover:opacity-100 hover:text-white flex items-baseline gap-1 translate-y-0 hover:translate-y-1 hover:scale-105 transition-all ease-out duration-300'>
      ...
      <div className='lg:hidden'>
        ...
        >
          <nav className={`text-secondary`}>
            <button
              onClick={handlerToggleOpen}
              className='text-5xl sm:text-6xl fixed top-15 right-5'
            >
              <i>
                <i className={`fa-solid fa-xmark`}></i>
              </i>
            </button>
            <ul className=' flex flex-col gap-12 pt-28 text-3xl sm:text-4xl '>
