...
import { SiJsonwebtokens, SiMaterialui, SiFirebase } from 'react-icons/si'
...
const TagCloud = () => {
  ...
  return (
    <div className='select-none'>
      <div
        className='mt-2  hidden lg:grid lg:grid-cols-2  gap-x-2'
        onMouseLeave={() => {
          setActive(false)
        }}
      >
                    ...
                    default:
                      return (
                        <i
                          className={`${
                            active
                              ? `${animation2} ${color} text-6xl animate-spin-slow`
                              : 'hidden'
                          }   ${icon}  `}
                        ></i>
                      )
